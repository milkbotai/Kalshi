...
class NWSClient:
    ...
    def get_forecast_hourly(self, office: str, grid_x: int, grid_y: int) -> dict[str, Any]:
    ...
    def get_observation_stations(self, office: str, grid_x: int, grid_y: int) -> dict[str, Any]:
