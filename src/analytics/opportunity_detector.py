...
class OpportunityDetector:
    ...
    def find_weather_markets(self, query: str, markets: list[Market]) -> list[Market]:
    ...
    def match_city_to_markets(self, city: str, markets: list[Market]) -> list[Market]:
        ...
        matched = [
            market
            for market in markets
            if city_upper in market.ticker.upper() or city_upper in market.event_ticker.upper()
        ]
    ...
    def calculate_market_relevance_score(self, market: Market, weather: dict[str, Any]) -> float:
